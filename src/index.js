...
/**
 * Provides the regular batch operation methods of Firestore but uses multiple
 * batch instances internally to work around the batch limit of 500 operations.
 */
class MultiBatch {
    /**
